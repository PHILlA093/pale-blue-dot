...
node _promo\record.js 8931 E:\qg_promo\check --stills 205,400,900,1500,2320 --prefix k

# 2) 全片渲染(2700 张 PNG,约 8-12 分钟;耗时主要取决于 AI 出题/讲解的等待)
node _promo\record.js 8931 E:\qg_promo\frames

# 3) 配乐 + 合成 + 交付到桌面
python _promo\music.py E:\qg_promo\music.wav
powershell -NoProfile -ExecutionPolicy Bypass -File _promo\assemble.ps1

# 只换配乐(视频帧没变,不必重编码 2700 帧,几秒钟出片)
python _promo\music.py E:\qg_promo\music.wav
powershell -NoProfile -ExecutionPolicy Bypass -File _promo\assemble.ps1 -SkipVideo
```
